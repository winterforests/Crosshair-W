...
export const SAMPLE_PRESETS = [
  preset('builtin-cross', 'Cross'),
  preset('builtin-t', 'T', { shape: 't' }),
...
/** Drop old bulk built-ins, keep Cross/T/Dot + user presets */
...
export const SHAPES = ['cross', 't', 'dot'];
